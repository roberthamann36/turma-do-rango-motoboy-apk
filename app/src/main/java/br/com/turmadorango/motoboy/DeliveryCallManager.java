...
public final class DeliveryCallManager {
    ...
    static final String CHANNEL_CALLS = "tdr_motoboy_calls_v2";
    ...
    private long pollOnce() throws Exception {
        ...
        try {
            // Usa o mesmo feed que já mantém as entregas/notificações em tempo real.
            // Isso evita depender de uma segunda consulta de sessão apenas para chamados.
    ...
    private void createChannel() {
        ...
        calls.setVibrationPattern(new long[]{0, 500, 220, 500, 220, 900});
    ...
    private void showOffer(JSONObject offer) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.O) {
            ...
            b.setVibrate(new long[]{0, 500, 220, 500, 220, 900});
        }

        ((NotificationManager) context.getSystemService(Context.NOTIFICATION_SERVICE))
                .notify(notificationId(callId), b.build());

        // Se o motoboy já estiver usando o aplicativo, abre imediatamente o card da chamada.
        // Em segundo plano, o Android mostra a notificação heads-up e o usuário toca nela.
        if (isAppForeground()) {
